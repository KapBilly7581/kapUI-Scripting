...

{
    ...
    function scankapUICode(namespace: string, code: any, path: string = "", file: string) {
        ...
        if (controls) {
            for (const elementObject of controls) {
                ...
                if (_code.controls) {
                    const childList = scankapUICode(_namespace, _code, fullName, file);
            ...
            for (const key in code) {
                ...
                if (_code.controls) {
                    const childList = scankapUICode(_namespace, _code, name, file);
    ...
    for (const file of fileList) {
        ...
        scankapUICode(namespace, jsonCode, "", uiPath);
    }
